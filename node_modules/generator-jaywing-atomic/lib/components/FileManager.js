...
function _addHtmlFiles(data) {
  var path = data.htmlDefinitionFilePath;
...
function _addSassDefinitionFile(data) {
  var path = data.sassDefinitionFilePath;
