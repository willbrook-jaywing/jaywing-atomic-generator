...
function _getSummaryObj(categoryName, name, description, sizeNames, moduleName) {
...
var self = module.exports = {
  ...
  getCategoryNames: function () {
    var names = _helper.getCategoryNamesFromCategoriesData(_data.componentData.categories);
    return names;
  },
  ...
  getSizeNames: function () {
    var names = _helper.getSizeNamesFromSizesData(_data.componentData.sizes);
    return names;
  },
