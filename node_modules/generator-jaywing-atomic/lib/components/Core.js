...
var self = module.exports = {
  ...
  add: function (categoryName, subCategoryName, name, description, sizeNames, moduleClassName) {
    ...
    var data = _DataHelper.createDataObj(categoryName, subCategoryName, name, description, sizeNames, moduleClassName);

    _FileManager.addToDocsData(data);
    _FileManager.addHtmlFiles(data);
    _FileManager.addNotesFiles(data);
    _FileManager.addSassFiles(data);
    if(moduleClassName) _FileManager.addModuleFiles(data);
