...
var self = module.exports = {
  ...
  createDataObj: function (categoryName, subCategoryName, name, description, sizeNames, moduleClassName) {
    ...
    obj.sassDefinitionFile = sassPath + _PropertyHelper.getSassDefinitionFileName(name);
    ...
    for (var i = 0; i < sizeNames.length; i++) {
      ...
      size.sassFile = sassPath + _PropertyHelper.getSassSizeFileName(name, sizeNames[i]);
      obj.sizes.push(size);
    }
