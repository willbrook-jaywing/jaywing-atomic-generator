...
var self = module.exports = {
  ...
  createDataObj: function (categoryName, subCategoryName, name, description, sizeNames, moduleClassName) {
    ...
    htmlPath += _PropertyHelper.getCategoryPath(categoryName);
    htmlPath += _PropertyHelper.getSubCategoryPath(subCategoryName);
    htmlPath += _PropertyHelper.getNamePath(name);
    obj.htmlPath = htmlPath;

    // html definition
    obj.htmlDefinitionFileName = _PropertyHelper.getHtmlDefinitionFileName(name);
    obj.htmlDefinitionFilePath = obj.htmlPath + obj.htmlDefinitionFileName;

    // notes
    var notesPath = _config.components.paths.notes;
    notesPath += _PropertyHelper.getCategoryPath(categoryName);
    notesPath += _PropertyHelper.getSubCategoryPath(subCategoryName);
    notesPath += _PropertyHelper.getNamePath(name);
    obj.notesPath = notesPath;

    obj.notesDefinitionFileName = _PropertyHelper.getNotesDefinitionFileName(name);
    obj.notesDefinitionFilePath = obj.notesPath + obj.notesDefinitionFileName;
    ...
    obj.sassDefinitionFilePath = obj.sassPath + obj.sassDefinitionFileName;
