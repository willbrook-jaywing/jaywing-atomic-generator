...
var self = module.exports = {
  ...
  createDataObj: function (categoryName, subCategoryName, name, description, sizeNames, moduleClassName) {
    ...
    // sass definition
    obj.sassDefinitionFile = _PropertyHelper.getSassDefinitionFileName(name);
    ...
    for (var i = 0; i < sizeNames.length; i++) {
      ...
      size.sassFile = _PropertyHelper.getSassSizeFileName(name, sizeNames[i]);
      obj.sizes.push(size);
    }

    // sass import
    obj.sassImportFile = _PropertyHelper.getSassImportFileName(name);
    obj.sassImports = '@import \'' + obj.sassDefinitionFile + '\';\n';
    for (var i = 0; i < obj.sizes.length; i++) {
      obj.sassImports += '@import \'' + obj.sizes[i].sassFile + '\';\n';
    }
