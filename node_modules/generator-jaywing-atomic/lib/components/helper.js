...
var self = module.exports = {
  ...
  getDataCategoryNamesFromCategories: function (categories) {
    var names = [];
  ...
  getDataSubCategoryNamesFromCategory: function (category) {
    var names = [];
  ...
  getDataSizeNamesFromSizes: function (sizes) {
    var names = [];
  ...
  getDataSummaryObj: function (categoryName, subCategoryName, name, description, sizeNames, moduleClassName) {
    ...
    obj.sizeCssClassNames = sizeNames.length > 0 ? this.getSizeCssClassNamesFromNameSizeNames(name, sizeNames) : 'N/A';
