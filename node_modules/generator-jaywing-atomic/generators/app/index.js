...
var _promptActionObj = _PromptHelper.getListObj('Action', ['Add Template Data', 'Exit']);
...
var baseExtension = {
  ...
  _promptAction: function () {
    ...
    return this.prompt(promptObj).then(function (answers) {
      if(answers.action == 'Add Template Data') _Core.add();
    }.bind(this));
  },
  ...
  prompting: function () {
    ...
    if(_Core.isReady()){
      ...
      this.log(_chalk.red('  No template data found!'));
      this._promptAction();
    }
