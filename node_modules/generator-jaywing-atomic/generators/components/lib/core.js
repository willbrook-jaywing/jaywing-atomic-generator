...
var self = module.exports = {
  ...
  getNames: function (categoryName, subCategoryName) {
    var names = _miner.getNamesFromSassFolders(categoryName, subCategoryName);
    return names;
  },
  ...
  add: function (categoryName, subCategoryName, name, description, sizeNames, moduleClassName) {
    ...
    _tempDataObj = _dataHelper.createDataObj(categoryName, subCategoryName, name, description, sizeNames, moduleClassName);
