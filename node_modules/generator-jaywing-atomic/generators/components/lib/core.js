...
var _miner = require('../../components/lib/helpers/dataMiner');
var _docsDataHelper = require('../../components/lib/helpers/dataDocsHelper');
var _helper = require('../../components/lib/helpers/dataHelper');

var _data = null;
var _tempDataObj = null;
...
function _addDocsData() {
  ...
  var docs = _miner.getDocsDataAsObj();
  var page = _docsDataHelper.extractDocsDataPage(docs, _tempDataObj.categoryName, _tempDataObj.subCategoryName);
  var pageItem = _docsDataHelper.createDocsDataPageItem(_tempDataObj.name);
...
var self = module.exports = {
  ...
  getCategoryNames: function () {
    var names = _helper.extractDataCategoryNames(_config.componentData.categories);
    return names;
  },
  ...
  getSizeNames: function () {
    var names = _helper.extractDataSizeNames(_config.componentData.sizes);
    return names;
  },
  ...
  add: function (categoryName, subCategoryName, name, description, sizeNames, moduleClassName) {
    ...
    _tempDataObj = _helper.getDataObj(categoryName, subCategoryName, name, description, sizeNames, moduleClassName);
