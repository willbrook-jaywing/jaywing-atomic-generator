...
function _addDocsData() {
  ...
  var page = _helper.extractDocsDataPage(docs, _tempDataObj.categoryName, _tempDataObj.subCategoryName);
  var pageItem = _helper.getDocsDataPageItem(_tempDataObj.name);
