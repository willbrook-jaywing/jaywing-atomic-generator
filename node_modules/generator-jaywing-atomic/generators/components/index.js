...
var _dataManager = require('../../lib/dataManager');
...
var _promptCategoryObj = {type: 'list', name: 'category', message: 'Category:', choices: []};
...
var baseExtension = {
  ...
  initializing: function () {
    ...
    _dataManager.initComponentData();
    _promptCategoryObj.choices = _dataManager.getComponentCategoryNames();
