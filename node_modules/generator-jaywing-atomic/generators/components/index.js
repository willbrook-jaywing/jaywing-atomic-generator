...
var baseExtension = {
  ...
  _add: function () {
      ...
      if(extension !== '.scss') {
        ...
        switch(extension) {
          ...
          case '.definition.scss':
            filePath = _pathSass + _categoryPath + '/' + _filePrefix + '.' + _namePath;
            break;
          case '.size.scss':
            filePath = _pathSass + _categoryPath + '/' + _filePrefix + '.' + _namePath;
            break;
    ...
    var extension = '.scss';
    var templatePath = _templateFilePrefix + extension;
    var filePath = _pathSass + _categoryPath + '/' + _filePrefix + '.' + _namePath;
  ...
  _delete: function () {
    for(var i = 0; i < _namePaths.length; i++) {
      ...
      var path = _pathSass + _categoryPath + '/' + namePath + '/';
