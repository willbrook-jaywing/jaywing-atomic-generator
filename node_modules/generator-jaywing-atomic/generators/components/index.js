...
var _templateFileExtensions = ['.html', '.md', '.config.scss', '.definition.scss', '.size.scss', '.js'];
var _rootPath = _config.components.rootPath;
var _filePrefix = _config.components.filePrefix;
var _tempColor = _config.components.tempColor;
var _tempBackground = _config.components.tempBackground;
var _tempPadding = _config.components.tempPadding;
...
var baseExtension = {
  ...
  _add: function () {
    ...
    var filePath = path + _filePrefix + '.' + _namePath;
    ...
    data.tempColor = _tempColor;
    data.tempBackground = _tempBackground;
    data.tempPadding = _tempPadding;
