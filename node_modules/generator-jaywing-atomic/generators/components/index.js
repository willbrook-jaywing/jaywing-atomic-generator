...
var _InputValidator = require('../../lib/components/InputValidator');
...
var _promptSelectTypeObj = _PromptHelper.getListObj('Type', ['Definition', 'Modifier']);
...
var baseExtension = {
  ...
  _promptSelectAction: function () {
    ...
    return this.prompt(promptObj).then(function (answers) {
      ...
      _action == 'Back' ? this._promptExit() : this._promptSelectType();
    }.bind(this));

  },

  _promptSelectType: function () {

    var promptObj = _promptSelectTypeObj;

    return this.prompt(promptObj).then(function (answers) {
      _type = answers.type;
      this._promptSelectCategoryName();
    }.bind(this));
  ...
  _promptSelectSubCategoryName: function () {
    ...
    if(promptObj.choices.length > 0) {
      ...
      _action == 'Add' ? this._promptSelectSubCategoryAction() : this._promptStart();
    }
  ...
  initializing: function () {
    ...
    _promptInputNameObj.validate = _InputValidator.validateName;
    _promptInputSubCategoryNameObj.filter = _PropertyHelper.getFormattedSubCategoryName;
    _promptInputSubCategoryNameObj.validate = _InputValidator.validateSubCategoryName;
  },
