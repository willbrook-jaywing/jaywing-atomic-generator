...
var baseExtension = {
  ...
  _promptSelectSizes: function () {
    ...
    var choices = _promptHelper.getInquirerPromptChoicesAsCheckboxChoices(sizeNames, true);
  ...
  _promptConfirmAdd: function () {
    ...
    _summaryObj = _dataHelper.getDataSummaryObj(_categoryName, _subCategoryName, _name, _description, _sizeNames, _moduleClassName);
    this._logSummary();
