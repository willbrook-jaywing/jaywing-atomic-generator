...
var baseExtension = {
    ...
    return this.prompt(promptObj).then(function (answers) {
      ...
      switch(_categoryName) {
        case 'Core':
          ...
          break;
        case 'Compounds':
          _action == 'Add' ? this._promptSelectSubCategoryAction() : this._promptSelectSubCategoryName();
          break;
      }
    }.bind(this));
  ...
  initializing: function () {
    _core.init();
    _promptInputNameObj.filter = _dataPropsHelper.getFormattedName;
    _promptInputNameObj.validate = _dataValidator.validateName;
    _promptInputSubCategoryNameObj.filter = _dataPropsHelper.getFormattedSubCategoryName;
