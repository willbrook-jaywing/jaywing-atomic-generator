...
var baseExtension = {
  ...
  _promptSelectCategoryName: function () {
    ...
    return this.prompt(_promptSelectCategoryNameObj).then(function (answers) {
      ...
      var subCategoryNames = _manager.getSubCategoryNames(_categoryName);
      subCategoryNames.length > 0 ? this._promptSelectSubCategoryName() : this._promptSelectSubCategoryAction();
    }.bind(this));
  },

  _promptSelectSubCategoryName: function () {
    _promptSelectSubCategoryNameObj.choices = _manager.getSubCategoryNames(_categoryName);
  ...
  _promptSelectModuleAction: function () {
    return this.prompt(_promptSelectModuleActionObj).then(function (answers) {
      ...
      switch(_moduleAction) {
        case 'Create New':
          _moduleClassName = _helper.getModuleClassNameFromName(_name);
  ...
  _promptSelectModuleClassName: function () {
    var choices = _manager.getModuleClassNames();
  ...
  _promptConfirmAdd: function () {
    _summaryObj = _manager.getSummaryObj(_categoryName, _name, _description, _sizeNames, _moduleClassName);
    this._logSummary();
  ...
  _logSummary: function () {
    ...
    this.log('    Module Class Name: ' + _summaryObj.moduleName);
    this.log(' ----------------------------------------');
  },
  ...
  initializing: function () {
    ...
    _promptStart = this._promptSelectAction;
  },
